...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Stats Section */}
      <section className="py-20 bg-gradient-to-br from-[#231f20] to-gray-900 text-white relative overflow-hidden">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#d19336] to-[#b8822a] text-white relative overflow-hidden">
